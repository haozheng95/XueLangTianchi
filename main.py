...
from code.predata.xml_txt_IOU import xml_txt_IOU
from code.predata.xml_txt_dataset import xml_txt_dataset
...
def train(**kwargs):
    ...
    val_dataloader = DataLoader(val_data, opt.val_batch_size, shuffle=True,
                                num_workers=opt.num_workers)  # 使用part123抽取的正负样本1:1来计算AUC
